...
class Test_validate_game(unittest.TestCase):
    def test_validate_game_tie(self):
        self.assertEqual("r", "r", "Tie since both players chose r")

    def test_validate_game_comp_wins(self):
        self.assertEqual(print_game_result("Computer", "r", "s"), print("Computer wins since r beats s"))
